            ...
            try {
                ...
                if ($auth_call->HasErrors) {
                    ...
                    if ($post['aramex_return_shipment_creation_date'] == "create") {
                        ...
                        $message_body = sprintf(__('<p dir="rtl">عزيزي <b>%s</b> </p>', 'aramex'), $post['aramex_shipment_receiver_name']);
                        $message_body .= sprintf(__('<p dir="rtl">رقم طلبك هو #%s </p>', 'aramex'),
                            $auth_call->Shipments->ProcessedShipment->Reference1);
                        $message_body .= sprintf(__('<p dir="rtl">تم إنشاء شحنة برقم: %s </p>', 'aramex'),
                            $auth_call->Shipments->ProcessedShipment->ID);
                        $message_body .= __('<p dir="rtl">يمكنك تتبع شحنتك من خلال <a href="http://www.aramex.com/express/track.aspx">http://www.aramex.com/express/track.aspx</a> </p>',
                            'aramex');
                        $message_body .= __('<p dir="rtl">في حال لديك أية أسئلة, يمكنك مراسلتنا على <b>support@orangebedbath.com</b> </p>',
                            'aramex');
                        $message = $mailer->wrap_message(
                        // Message head and message body.
                            sprintf(__('تم إنشاء الشحنة رقم #%s', 'aramex'), $order->get_id()), $message_body);
